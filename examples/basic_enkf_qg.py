# 🧪 Official method: 'enkf' using AnalysisFactory and QGModel
import numpy as np
...
analysis = AnalysisFactory("enkf", model=model).create_analysis()
...
plt.title("EnKF with QGModel – Log10 Errors")
plt.legend()
plt.grid(True)
plt.show()
